    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col lg:flex-row overflow-x-hidden">
        ...
        <div class="flex-1 flex flex-col min-w-0 min-h-screen bg-gray-50/50 dark:bg-gray-900">
            ...
            <footer class="shrink-0 px-4 sm:px-8 lg:px-14 py-8 pb-32 lg:pb-8 border-t border-gray-100 dark:border-gray-700/50 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm">
                <div class="flex flex-row lg:flex-row items-center justify-between gap-2 sm:gap-4 lg:gap-8">
                    ...
                    <div class="flex items-center gap-2 sm:gap-4 bg-gray-50/50 dark:bg-gray-900/30 px-2 sm:px-5 py-2 rounded-xl border border-gray-100 dark:border-gray-700/50 shadow-inner">
                        <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest hidden sm:inline">Dev by</span>
