        ...
        <form @submit.prevent="submit" class="space-y-6 sm:space-y-10 transition-all duration-500">
            ...
            <div class="bg-gray-50/80 dark:bg-gray-900/40 p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 relative group transition-all duration-700 hover:border-pail-gold/30 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]">
                ...
                <div class="relative z-10">
                    ...
                    <div class="mt-5 flex items-start gap-3 sm:gap-4 p-4 bg-white/50 dark:bg-gray-800/50 rounded-2xl border border-gray-100/50 dark:border-gray-700/50">
                ...
                <div class="group relative">
                    <div class="flex items-center justify-between mb-3 px-2">
                        ...
                        <Link
                            ...
                            class="text-[7px] sm:text-[9px] font-black text-pail-gold hover:text-yellow-600 uppercase tracking-widest transition-colors decoration-2 underline-offset-4 hover:underline"
                        >
                            Lupa Kunci?
                        </Link>
                    </div>
            ...
            <div class="pt-6">
                ...
                >
                    ...
                    <span v-else class="flex items-center gap-3 sm:gap-4 text-pail-gold font-black uppercase tracking-[0.3em] sm:tracking-[0.4em]">
                        Login
