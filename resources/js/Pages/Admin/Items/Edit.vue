                ...
                <div class="bg-white dark:bg-gray-800 shadow-2xl rounded-[3rem] border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div class="p-12">
                        <header class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                                <h3 class="text-3xl font-black text-gray-900 dark:text-white tracking-tighter uppercase mb-2">Pembaruan Aset</h3>
                            ...
                            <div class="flex items-center gap-4">
                                <span class="px-6 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest border shadow-sm bg-blue-50 text-blue-700 border-blue-100">
                                    ID: {{ item.id }}
                                </span>
                            </div>
                        </header>
