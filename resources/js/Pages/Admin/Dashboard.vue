    ...
    <AuthenticatedLayout>
        ...
        <div class="pt-6 pb-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-12">
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-[3.5rem] p-12 shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden group">
                    ...
                    <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
                        <div class="flex-1">
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <span class="text-[10px] font-black text-pail-gold uppercase tracking-[0.4em]">Administrative Headquarter</span>
                            </div>
                            <h1 class="text-5xl font-black text-gray-900 dark:text-white mb-4 tracking-tighter uppercase leading-none">{{ greeting }}, {{ user.name.split(' ')[0] }}!</h1>
                            <p class="text-gray-400 max-w-2xl leading-relaxed font-bold text-sm uppercase tracking-tight">
                                Integrated Management System for <span class="text-pail-gold">Abu Hurairah Foundations</span>. You have <span class="text-gray-900 dark:text-white underline decoration-pail-gold decoration-4 underline-offset-4">{{ stats.pending_requests }} active requests</span> awaiting verification protocols.
                            </p>
                        </div>
                        <div class="flex items-center gap-6">
                            <Link :href="route('admin.requests.index')" class="px-10 py-6 bg-gray-900 text-pail-gold rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] hover:bg-black transition-all shadow-2xl shadow-black/20 flex items-center gap-4 group/btn">
                                Intelligence Center
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="bg-white dark:bg-gray-800 p-10 rounded-[3rem] border border-gray-100 dark:border-gray-700 shadow-sm relative group overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
                        ...
                        <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4 relative z-10">Institutions</h4>
                        <div class="flex items-end gap-2 relative z-10 leading-none">
                            <div class="text-5xl font-black text-gray-900 dark:text-white tracking-tighter">{{ stats.total_institutions }}</div>
                    ...
                    <div class="bg-white dark:bg-gray-800 p-10 rounded-[3rem] border border-gray-100 dark:border-gray-700 shadow-sm relative group overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
                        ...
                        <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4 relative z-10">Total Human Capital</h4>
                        <div class="flex items-end gap-2 relative z-10 leading-none">
                            <div class="text-5xl font-black text-gray-900 dark:text-white tracking-tighter">{{ stats.total_users }}</div>
                            <span class="text-[10px] font-black text-gray-300 uppercase mb-1">Staff</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 p-10 rounded-[3rem] border border-gray-100 dark:border-gray-700 shadow-sm relative group overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
                        ...
                        <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4 relative z-10">Total Inventories</h4>
                        <div class="flex items-end gap-2 relative z-10 leading-none">
                            <div class="text-5xl font-black text-gray-900 dark:text-white tracking-tighter">{{ stats.total_items }}</div>
                            <span class="text-[10px] font-black text-gray-300 uppercase mb-1">SKUs</span>
                        </div>
                    </div>

                    <div class="bg-gradient-to-br from-red-500 to-red-600 p-10 rounded-[3rem] shadow-2xl shadow-red-500/20 relative overflow-hidden group hover:scale-[1.02] transition-all duration-500">
                        <div class="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <h4 class="text-[10px] font-black text-red-100 uppercase tracking-[0.3em] mb-4 relative z-10 italic">Critical Stock Alert</h4>
                        <div class="text-5xl font-black text-white tracking-tighter relative z-10 leading-none">{{ stats.low_stock_items }}</div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="bg-white dark:bg-gray-800 p-10 rounded-[3rem] border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col justify-between group hover:shadow-xl transition-all">
                        <div>
                            <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4">Pending Financial Liability</h4>
                            <div class="text-4xl font-black text-gray-900 dark:text-white tracking-tighter group-hover:text-pail-gold transition-colors leading-none mb-2">{{ formatRupiah(stats.total_cost_pending) }}</div>
                            <p class="text-[10px] font-black text-gray-300 uppercase">Estimasi pengeluaran antrian</p>
                        </div>
                        <div class="mt-10 pt-8 border-t border-gray-50 dark:border-gray-700/50">
                            <div class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-3">Approved Disbursements</div>
                            <div class="text-2xl font-black text-gray-700 dark:text-gray-300 tracking-tighter leading-none">{{ formatRupiah(stats.total_cost_approved) }}</div>
                        </div>
                    </div>

                    <div class="bg-gradient-to-br from-[#D4B876] via-pail-gold to-[#B89648] p-10 rounded-[3rem] shadow-2xl shadow-pail-gold/30 flex flex-col justify-between relative overflow-hidden group hover:-translate-y-1 transition-all duration-500">
                        <div class="absolute top-0 right-0 p-8 opacity-10 group-hover:rotate-12 transition-transform duration-700">
                            <svg class="w-32 h-32 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                        </div>
                        <div class="relative z-10">
                            <h4 class="text-[10px] font-black text-white/70 uppercase tracking-[0.3em] mb-4">Operational Depletion</h4>
                            <div class="text-6xl font-black text-white tracking-tighter leading-none mb-2">{{ stats.out_of_stock }}</div>
                            <p class="text-xs text-black/40 font-black uppercase tracking-widest italic">Out of Stock Assets</p>
                        </div>
                    ...
                    <div class="bg-gray-900 dark:bg-black p-10 rounded-[3rem] shadow-2xl flex flex-col justify-center border border-white/5 relative group overflow-hidden">
                        <div class="absolute inset-0 bg-pail-gold/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="relative z-10 flex items-center gap-8">
                            <div class="w-20 h-20 rounded-[2rem] bg-pail-gold/10 border border-pail-gold/20 flex items-center justify-center text-pail-gold group-hover:scale-110 transition-transform shadow-2xl shadow-pail-gold/20">
                                <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                            </div>
                            <div>
                                <h4 class="text-[10px] font-black text-pail-gold/70 uppercase tracking-[0.3em] mb-2">Live Connections</h4>
                                <div class="text-4xl font-black text-white tracking-tighter leading-none mb-2">{{ stats.online_users }} Nodes</div>
                                <div class="flex items-center gap-2">
                                    <span class="w-2 h-2 rounded-full bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)] animate-pulse"></span>
                                    <p class="text-[10px] text-green-500 font-black uppercase tracking-widest">Authorized Access</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        <div class="flex items-center justify-between px-6">
                            <div class="flex items-center gap-4">
                                ...
                                <h3 class="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Recent Strategic Proposals</h3>
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-[3.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden relative">
                            <div v-if="recent_requests.length === 0" class="p-40 text-center relative overflow-hidden">
                                ...
                                <div class="relative z-10 flex flex-col items-center">
                                    ...
                                    <p class="text-gray-400 font-black uppercase tracking-[0.3em] text-sm">Communication Silo Empty</p>
                                    <p class="text-[10px] text-gray-300 font-bold mt-2 uppercase">No pending proposals within the queue.</p>
                                </div>
                            </div>
                                ...
                                <div v-for="req in recent_requests" :key="req.id" class="p-8 hover:bg-gray-50/80 dark:hover:bg-gray-900/50 rounded-[2.5rem] transition-all flex items-center justify-between group border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                                    ...
                                    <div class="flex items-center gap-8">
                                        <div class="text-right hidden sm:block">
                                            <div class="text-[10px] font-black text-gray-300 uppercase tracking-[0.2em] mb-1">Financial Est.</div>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-center justify-between px-6">
                            <h3 class="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">System Pulse</h3>
                        ...
                        <div class="bg-gray-900 dark:bg-black rounded-[3.5rem] shadow-2xl p-10 relative overflow-hidden group">
                            ...
                            <div class="space-y-10 relative z-10">
                                ...
                                <div v-for="log in recent_activity" :key="log.id" class="flex gap-6 relative group/item">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-400 leading-relaxed uppercase tracking-tight">
                                            ...
                                            <span class="mx-1 lowercase opacity-50">has executed</span>
                                ...
                                <div v-if="recent_activity.length === 0" class="py-20 text-center relative">
                                    <div class="text-4xl mb-4 opacity-10">💤</div>
                                    <p class="text-[10px] font-black text-white/20 uppercase tracking-[0.4em]">Zero latency detected</p>
                                </div>
                            </div>
